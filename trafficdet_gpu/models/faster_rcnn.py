...
class FasterRCNNConfig:
    ...
    def __init__(self):
        ...
        #self.anchor_scales = [[x] for x in [8, 16, 32, 64, 128]]
        self.anchor_scales = [[x] for x in [16, 32, 64, 128, 256]]
        #self.anchor_scales = [[x] for x in [6, 12, 24, 48, 96]]
        self.anchor_ratios = [[0.5, 1, 2]]
        self.anchor_offset = 0.5

        self.match_thresholds = [0.3, 0.7]
        #self.match_thresholds = [0.3,0.5]
        ...
        #self.rpn_smooth_l1_beta = 1.0  # use L1 loss
        #self.rcnn_smooth_l1_beta = 1.0  # use L1 loss
        self.num_losses = 5

        # ------------------------ training cfg ---------------------- #
        #self.train_image_short_size = (1024,1056,1152,1184)
        self.train_image_short_size = (1280)
        self.train_image_max_size = 1920
        ...
        # ------------------------ testing cfg ----------------------- #
        #self.test_image_short_size = 1152
        self.test_image_short_size = 1280
        self.test_image_max_size = 1920
